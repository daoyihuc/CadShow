 ...
 * @date :
 */
public class DragScaleCircleView extends View implements View.OnTouchListener {
    ...
    public DragScaleCircleView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawOval(offset, offset, getWidth() - offset, getHeight()
                - offset, paint);
    }
