 ...
 * @date :
 */
public class DragScaleRectView extends View implements View.OnTouchListener {
    ...
    public DragScaleRectView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setOnTouchListener(this);
        initScreenW_H();
    }

    public DragScaleRectView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOnTouchListener(this);
        initScreenW_H();
    }

    public DragScaleRectView(Context context) {
        super(context);
        setOnTouchListener(this);
        initScreenW_H();
    }
