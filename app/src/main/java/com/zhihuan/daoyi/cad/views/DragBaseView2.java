 ...
 * @date :
 */
public class DragBaseView2 extends RelativeLayout implements View.OnTouchListener {
    ...
    public interface Option{
        int Type();// 设置type
        void select(DragBaseView2 view);
    }
    ...
    public DragBaseView2(Context context, int type, int flag) {
        super(context);
    ...
    public DragBaseView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext= context;
        init();
    }

    public DragBaseView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        right=getRight();
        bottom=getBottom();
        dragDirection = getDirection(v,(int) event.getRawX(),(int) event.getRawY());
        // 处理拖动事件
        delDrag(v, event);
        return true;
    }
