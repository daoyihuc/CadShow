 ...
 * @params: "说明...."
 */
public class PowerFullLayout2 extends FrameLayout {
    // 屏幕宽高
    ...
    public PowerFullLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public PowerFullLayout2(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public PowerFullLayout2(Context context) {
        this(context,null);
    }
...
//            }
    ...
    public class ScaleGestureListener implements
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            // 缩放view
            if (scale > 0.5) {
                ViewHelper.setScaleX(PowerFullLayout2.this, scale);// x方向上缩放
                ViewHelper.setScaleY(PowerFullLayout2.this, scale);// y方向上缩放
            }
            return false;
        }
